...
Before making any contribution, you, the AI AGENT or Collaborator, **MUST** recursively read, understand, and adhere to the entire contents of the [`ai_context`](../../docs/notes/ai_context) directory. This is not an optional step.
...
**By proceeding with any contribution, you affirm that you have fully reviewed and understood the complete contents of the [../../docs/ai_context/](../../docs/notes/ai_context/00_README.md) directory.**
...
2.  Revise all docs, code, and assets to ensure full compatibility with updated "types" as defined in the [./docs/ai_context/type_canon_glossary.md](../../docs/notes/ai_context/type_canon_glossary.md) file. []
...
4.  Review and revise `mutagen` data shape and file structure (.yaml) strictly adhere to their respective schemas as defined in [./docs/ai_context/schemas/mutagen_schema.md](../../docs/notes/ai_context/schemas/mutagen_schema.md). []
