...
TYPE_VISUALS = {  # --- 3. BODY PLAN (60% Weight)
    "Stone": "typically thicker physique, rock-hewn or crystallized structures and silhouettes, diverse mineral textures/colors",
    ...
    "Plant": "organic shapes and limbs, leaf/flower/root/petal clusters, often undergrowth or bark textured, rarely bipedal",
    ...
    "physical features",
    "Flame": "visible evidence of extreme heat without implying 'fire related damage or trauma', smoke tendrils, heat distortion",
    ...
    "N/A": "desaturated palette, ghostly transparency, minimalist features",
}
