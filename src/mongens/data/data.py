...
SEEDTYPE_ATTR = {
    ...
    "Aquatic": {
        ...
        "add": {},
        "tags": ["Amphibious", "Resist:Flame", "Weak:Electric"],
    },
    "Ice": {
        "mul": {"SPDEF": 1.40, "HP": 1.15, "SPATK": 1.15, "SPD": 0.85},
        "add": {"SPDEF": 5},
        "tags": ["FrostAura", "Resist:Aquatic", "Weak:Flame"],
    },
    "Brawler": {
    ...
    "Insect": {
        ...
        "add": {"EVA": 5},
        "tags": ["Swarm", "Exoskeleton", "Weak:Aerial", "Weak:Flame"],
    },
    "Mythic": {
    ...
    "Electric": {
        ...
        "add": {},
        "tags": ["HighVoltage", "Resist:Aerial", "Weak:Stone"],
    },
    "Plant": {
        "mul": {"HP": 1.40, "SPDEF": 1.2, "SPATK": 1.15, "SPD": 0.80},
        "add": {},
        "tags": ["Regrowth", "Weak:Toxic", "Resist:Aquatic", "Weak:Flame"],
    },
    "Aerial": {
    ...
    "Toxic": {
        ...
        "add": {},
        "tags": ["Poisonous", "Corrosive", "Weak:Stone", "Weak:Plant"],
    },
    "Ancient": {
...
TYPE_SYNERGY_BOOSTS = {
    ...
    frozenset(["Stone", "Brawler"]): 1.10,
    frozenset(["Flame", "Dread"]): 1.10,
    frozenset(["Aerial", "Beast"]): 1.10,
    frozenset(["Insect", "Stone"]): 1.15,
    frozenset(["Plant", "Dread"]): 1.00,
    frozenset(["Insect", "Ancient"]): 1.15,
    frozenset(["Aerial", "Electric"]): 0.60,
}

INCOMPATIBLE_TYPE_PAIRS = {
    frozenset(["Beast", "Plant"]),
    frozenset(["Ice", "Electric"]),
    frozenset(["Astral", "Mythic"]),
    frozenset(["Flame", "Aquatic"]),
    frozenset(["Flame", "Ice"]),
    frozenset(["Electric", "Stone"]),
    frozenset(["Toxic", "Stone"]),
    frozenset(["Brawler", "Aquatic"]),
    frozenset(["Mythic", "Dread"]),
    frozenset(["Flame", "Plant"]),
    frozenset(["Flame", "Toxic"]),
...
MAJOR_MODS = {
    "Starwarden": {
        ...
        "allowed_types": ["Mythic", "Astral", "N/A"],
        "rarity": 1.3,
    ...
    "BrightFlare": {
        ...
        "allowed_types": ["Flame", "Aerial", "Electric"],
        "rarity": 0.9,
        "synergy_bonus": {"Flame": 1.5},
    },
    "ExoSkeleton": {
    ...
    "DeepEarth": {
        ...
        "allowed_types": ["Stone", "Ancient", "Dread"],
        "rarity": 0.9,
    ...
    "Riftwalker": {
        ...
        "allowed_types": ["Astral", "Dread", "N/A"],
        "rarity": 1.2,
    ...
    "Obsidian": {
        ...
        "allowed_types": ["Stone", "Flame", "Ancient"],
        "rarity": 1.0,
        "synergy_bonus": {"Flame": 1.2},
    },
    "Bloodforge": {
        "mul": {"ATK": 1.28, "HP": 1.12, "DEF": 1.08},
        "add": {},
        "tags": ["Regen:OnHit", "Weak:Radiant", "Hemofury"],
        "allowed_types": ["Stone", "Dread", "Brawler", "Flame"],
        "rarity": 1.4,
        "synergy_bonus": {"Stone": 1.2, "Flame": 1.2},
    },
    "Crystalline": {
        "mul": {"SPDEF": 1.15},
        "add": {"HP": 10},
        "tags": ["Resist:Mind", "Shatter:OnCrit"],
        "allowed_types": ["Stone", "Ice", "Astral"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Cavernborn": {
        ...
        "allowed_types": ["Stone", "Beast", "Dread", "Insect"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Arctic": {
    ...
    "FullBloom": {
        ...
        "allowed_types": ["Plant", "Toxic"],
        "rarity": 1.0,
        "synergy_bonus": {"Plant": 1.2},
    },
    "RuneReader": {
    ...
    "SuperOrbital": {
        ...
        "allowed_types": ["Ancient", "N/A", "Astral", "Mythic", "Dread"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "SandCrawler": {
        ...
        "allowed_types": ["Stone", "Beast", "Insect"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Brimstone": {
        ...
        "allowed_types": ["Flame", "Stone", "Dread"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "LoreGuardian": {
    ...
    "Paranormal": {
        ...
        "allowed_types": ["Dread", "Astral", "Mythic", "N/A"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Feralkin": {
    ...
    "ArcheoAnomaly": {
        ...
        "allowed_types": ["Ancient", "Astral", "N/A"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Tectonic": {
    ...
    "Radiant": {
        ...
        "add": {"ACC": 10},
        "tags": ["Cure:Blind", "Weak:Shade", "HolyLight"],
        "allowed_types": ["Mythic", "Astral", "N/A"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "BioLuminous": {
        ...
        "allowed_types": ["Plant", "Aquatic", "Insect"],
        "rarity": 1.0,
    ...
    "Psychic": {
        ...
        "add": {"LUCK": 5},
        "tags": ["Pierce:Barrier", "Weak:Obsidian", "Resist:Cosmic"],
        "allowed_types": ["Mythic", "Astral", "N/A", "Dread"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Solar": {
        ...
        "allowed_types": ["Flame", "Aerial", "Mythic", "Plant"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Nocturnal": {
    ...
    "Chaotic": {
        ...
        "allowed_types": ["Dread", "Astral", "N/A"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Monolithic": {
        ...
        "allowed_types": ["Stone", "Ancient", "Beast"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Tempest": {
    ...
    "Shielded": {
        ...
        "add": {"DEF": 15},
        "tags": ["Guard:Stagger", "Weak:Shade", "Ironclad"],
        "allowed_types": ["Brawler", "Stone", "Ancient", "Beast"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "Vulcan": {
    ...
    "Fossilized": {
        ...
        "add": {},
        "tags": ["Ability:Revive", "Resist:Stone"],
        "allowed_types": ["Ancient", "Stone", "Beast"],
        "rarity": 1.0,
        "synergy_bonus": {},
    },
    "BoltThrower": {
    ...
    "Stormforged": {
        ...
        "add": {},
        "tags": ["Resist:Tempest", "Weak:Stone", "Stormbringer"],
    ...
    "Verdant": {
        ...
        "add": {"HP": 20},
        "tags": ["Regen:Terrain", "Weak:Fire", "Photosynthesis"],
        "allowed_types": ["Plant", "Toxic", "Aquatic"],
        "rarity": 0.9,
        "synergy_bonus": {"Plant": 1.1},
    },
    "Shade": {
    ...
    "Fey-touched": {
        ...
        "allowed_types": ["Mythic", "Plant", "Insect", "Astral"],
        "rarity": 1.3,
        "synergy_bonus": {"Mythic": 1.4},
    },
}
...
UTILITY_MODS = {
    ...
    "Symbiote": {
        ...
        "rarity": 1,
        "allowed_types": ["Plant", "Insect", "Aquatic"],
    },
    "Ageless": {
        "exp_mult": 1.15,
        "loot_mult": 1.20,
    ...
    "SuperPositioned": {
        ...
        "allowed_types": ["Astral", "Electric", "N/A"],
    },
    "CombatController": {
    ...
    "NaturalDetector": {
        ...
        "allowed_types": ["Electric", "Stone", "Brawler"],
    },
    "Confidant": {
        "npc_dialog_plus": True,
        "minimap_reveal": True,
    ...
    "Pathwarden": {
        ...
        "allowed_types": ["Stone", "Beast", "Aerial", "Ancient"],
    },
    "MasterCrafter": {
        "crafting_bonus": 0.25,
        "crafting_speed_mult": 1.5,
        "tags": ["Artisan", "Tinkerer", "Masterwork"],
        "allowed_types": ["Brawler", "Astral", "Stone", "Ancient"],
    },
}
