...
from .dex_entries import dex_formatter, generate_dex_batch
...
from .monsterseed import (
    MonsterSeed,
)  # This line is not used, but kept for potential future use.
...
def main():
    ...
    parser_dex.add_argument(
        ...
        "--output",
        type=str,
        default="C:\\Users\\Bean\\Desktop\\PokeDex\\mongen_dexentry.txt",
    ...
    parser_prompt.add_argument(
        ...
        type=int,
        default=1,
        choices=[range(21)] + ["random"],
        help="Number of prompt " "dictionaries to generate.",
    )
    parser_prompt.add_argument(
        "-maj",
        "--majors",
        ...
        for i in range(args.count):
            ...
            try:
                monster_template = forge_seed_monster(
                    idnum=i + 1, primary_type=p_type, secondary_type=s_type
                )
