...
from .data import SEED_TYPES, ALL_HABITATS, MAJOR_MODS, MINOR_MODS, UTILITY_MODS
...
def main():
    ...
    parser_dex.add_argument("-t2", "--secondary_type", type=str, default=None, choices=SEED_TYPES + ["random", None], help="Optional secondary type.")
    parser_dex.add_argument("-c", "--count", type=int, default=1, help="Number of monsters to generate.")
    parser_dex.add_argument("-o", "--output", type=str, help="Optional file path to save the generated dex entries.")
    ...
    parser_unique.add_argument("-t2", "--secondary_type", type=str, default="random", choices=SEED_TYPES + ["random", None], help="Optional secondary type. Set to 'random' for a 60%% chance of a secondary type.")
    ...
    parser_prompt.add_argument("--majors", type=int, default=1, help="Number of major mutagens.")
    parser_prompt.add_argument("--minors", type=int, default=2, help="Number of minor mutagens.")
    parser_prompt.add_argument("--utils", type=int, default=1, help="Number of utility mutagens.")
    parser_prompt.add_argument("-o", "--output", type=str, help="Optional path to append the prompt to a file.")
